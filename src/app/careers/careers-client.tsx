        ...
        <div className="container mx-auto px-4">
          ...
          {!jobs || jobs.length === 0 ? (
            <div className="text-center py-16 bg-white border border-[#E2E8F0] rounded-2xl">
               ...
               <p className="text-[#64748B] text-sm text-center">We are not actively hiring right now, but feel free to send us your resume.</p>
            </div>
          ) : (
                  ...
                  {openJob === i && (
                    <div className="px-6 pb-6 border-t border-[#E2E8F0] pt-5">
                      ...
                      <ul className="space-y-2 mb-5">
                        {(Array.isArray(job.requirements) ? job.requirements : []).map((r: string) => (
