    ...
    <div className="min-h-screen bg-[#F8FAFC] flex font-sans">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#0F172A] flex flex-col transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>
        ...
        <div className="px-3 py-4">
          <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold capitalize ${
            profile?.role === "staff" ? "bg-blue-500/20 text-blue-300" : "bg-[#0D9488]/20 text-[#2DD4BF]"
          }`}>
        ...
        <div className="p-4 border-t border-white/10">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-full bg-[#0D9488] flex items-center justify-center text-white font-bold text-xs overflow-hidden relative">
              {profile?.avatar_url ? (
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[#64748B] text-xs capitalize">{profile?.role || "user"}</p>
            </div>
          </div>
      ...
      <main className="flex-1 lg:ml-64 min-h-screen">
        ...
        <header className="bg-white border-b border-[#E2E8F0] px-6 py-4 flex items-center justify-between sticky top-0 z-30">
          ...
          <Link href="/" className="text-xs text-[#64748B] hover:text-[#0D9488] transition-colors">← View Site</Link>
        </header>
            ...
            <>
              ...
              {active === "profile" && (
                <div className="max-w-xl space-y-6">
                  <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        ...
                        <span className={`inline-block mb-4 px-2.5 py-0.5 rounded-full text-xs font-semibold capitalize ${
                          profile?.role === "staff" ? "bg-blue-100 text-blue-700" : "bg-[#F0FDFA] text-[#0D9488]"
                        }`}>{profile?.role}</span>
                  ...
                  <div className="bg-[#F0FDFA] rounded-2xl border border-[#CCFBF1] p-5">
                    <p className="text-sm text-[#0F172A] font-medium mb-1">Need to update your profile?</p>
                    <p className="text-xs text-[#64748B]">Contact your Admin to update your name, role, or other details.</p>
                  </div>
